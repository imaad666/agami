  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-start justify-center overflow-hidden pt-32 sm:pt-40">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight mb-6 mt-0.5 text-[#0D1B2A]">
          <span className="text-[#1e3a5f]">AAGAMI</span><span className="text-[#C71585]">SEQ</span> Nanopore
          <br />
          Diagnostics
        </h1>

        <p className="text-xl sm:text-2xl text-[#0D1B2A]/70 max-w-3xl mx-auto mt-1">
